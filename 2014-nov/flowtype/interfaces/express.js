...
declare module "express" {
    ...
    module e {
        ...
        declare class IRouterMatcher<T> {
            (name: string, ...handlers: RequestHandler[]): T;
            (name: RegExp, ...handlers: RequestHandler[]): T;
        }

        declare class IRouter<T> extends RequestHandler {
            /**
        ...
        export declare class Router extends IRouter<Router> {}
        ...
        declare class Errback { (err: Error): void; }

        declare class Request extends http.ServerRequest, Express.Request {
        ...
        declare class Response extends http.ServerResponse, Express.Response {
            /**
             * Set status `code`.
             *
             * @param code
        ...
        declare class ErrorRequestHandler {
        ...
        declare class Handler extends RequestHandler {}

        declare class RequestParamHandler {
            (req: Request, res: Response, next: Function, param: any): any;
        }

        declare class Application extends IRouter<Application>, Express.Application {
            /**
        ...
        declare class Express extends Application {
            /**
             * Framework version.
             */
            version: string;
